...
function ClientCard({
  ...
  return (
    <a
      ...
      ref={cardRef}
      className={`group relative flex flex-col items-center justify-center p-6 rounded-2xl border bg-card/50 backdrop-blur-sm transition-all duration-500 cursor-pointer ${
        isHovered
